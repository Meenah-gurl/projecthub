                ...
                <div>
                    <form action="" method="post">
                        <?php 
                            ...
                            if(isset($_POST['subChp4'])){
                                $stdid = $user_data['id'];
                                $chapter4=$_POST['chapter4'];
                                
                                $sql_string="INSERT INTO chapter4(student_id, chapter4)
                                VALUES('".$stdid."', '".$chapter4."')";
                                
                                if($conn->query($sql_string)){
                                    echo 'Chapter Four  Successfully Submitted';
                        ...
                        <div class="mt-4">
                            ...
                            <div class=" text-gray-700 rounded-lg mb-3">
                                <textarea name="chapter4" id="editor" class="rounded-lg  bg-opacity-75 shadow-lg "></textarea>
                        ...
                        <div class="float-right text-center text-md">
                            <button class="py-2 px-2 text-white bg-green-700 rounded-lg shadow-lg" name="subChp4">Submit Chapter Four</button>
                        </div>
                    </form>
                </div>
            </div>
